...
import 'package:placesnearby/services/geolocator_service.dart';
import 'package:placesnearby/services/marker_service.dart';
import 'package:placesnearby/services/places_service.dart';
...
class ApplicationBloc with ChangeNotifier {
  ...
  togglePlaceType(String value, bool selected) async {
    print('Is $value Selected: $selected');
    if (selected) {
      placeType = value;
    } else {
      placeType = null;
